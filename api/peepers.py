...
def main():
    ...
    while True:
        ...
        windSub = dataList[0][1] - 23
        humidSub = -1 * ((((dataList[0][8] * 10) - 650) / 100) - 1)
        if tempSub < 0:
            tempSub = 0
        elif tempSub > 5:
            tempSub = 5
        ...
        if (psp0 > utc) or (utc > pep0):
            if peepersMax >= 0:
                ...
                if pn0 == 0:
                    pn0 = 1
                    pytools.sound.main.playSoundWindow("m_peepers_0_fi.mp3;peepers_0_fi.mp3", 25, 1.0, 0.0, 0)
                elif pn0 == 1:
                    pytools.sound.main.playSoundWindow("m_peepers_0.mp3;peepers_0.mp3", 25, 1.0, 0.0, 0)
        if pf0 == 0:
            if pn0 == 1:
                pn0 = 0
                pytools.sound.main.playSoundWindow("m_peepers_0_fo.mp3;peepers_0_fo.mp3", 25, 1.0, 0.0, 0)
        ...
        if (psp1 > utc) or (utc > pep1):
            if peepersMax >= 1:
                ...
                if pn1 == 0:
                    pn1 = 1
                    pytools.sound.main.playSoundWindow("m_peepers_1_fi.mp3;peepers_1_fi.mp3", 25, 1.0, 0.0, 0)
                elif pn1 == 1:
                    pytools.sound.main.playSoundWindow("m_peepers_1.mp3;peepers_1.mp3", 25, 1.0, 0.0, 0)
        if pf1 == 0:
            if pn1 == 1:
                pn1 = 0
                pytools.sound.main.playSoundWindow("m_peepers_1_fo.mp3;peepers_0_fo.mp3", 25, 1.0, 0.0, 0)
        ...
        if (psp2 > utc) or (utc > pep2):
            if peepersMax >= 2:
                ...
                if pn2 == 0:
                    pn2 = 1
                    pytools.sound.main.playSoundWindow("m_peepers_2_fi.mp3;peepers_2_fi.mp3", 25, 1.0, 0.0, 0)
                elif pn2 == 1:
                    pytools.sound.main.playSoundWindow("m_peepers_2.mp3;peepers_2.mp3", 25, 1.0, 0.0, 0)
        if pf2 == 0:
            if pn2 == 1:
                pn2 = 0
                pytools.sound.main.playSoundWindow("m_peepers_2_fo.mp3;peepers_2_fo.mp3", 25, 1.0, 0.0, 0)
        ...
        if (psp3 > utc) or (utc > pep3):
            if peepersMax >= 3:
                ...
                if pn3 == 0:
                    pn3 = 1
                    pytools.sound.main.playSoundWindow("m_peepers_3_fi.mp3;peepers_3_fi.mp3", 25, 1.0, 0.0, 0)
                elif pn3 == 1:
                    pytools.sound.main.playSoundWindow("m_peepers_3.mp3;peepers_3.mp3", 25, 1.0, 0.0, 0)
        if pf3 == 0:
            if pn3 == 1:
                pn3 = 0
                pytools.sound.main.playSoundWindow("m_peepers_3_fo.mp3;peepers_3_fo.mp3", 25, 1.0, 0.0, 0)
        ...
        if (psp4 > utc) or (utc > pep4):
            if peepersMax >= 4:
                ...
                if pn4 == 0:
                    pn4 = 1
                    pytools.sound.main.playSoundWindow("m_peepers_4_fi.mp3;peepers_4_fi.mp3", 25, 1.0, 0.0, 0)
                elif pn4 == 1:
                    pytools.sound.main.playSoundWindow("m_peepers_4.mp3;peepers_4.mp3", 25, 1.0, 0.0, 0)
        if pf4 == 0:
            if pn4 == 1:
                pn4 = 0
