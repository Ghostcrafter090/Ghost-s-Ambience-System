...
def main():
    while True:
        ...
        if (random.random() * 32768) < chance[5]:
            pytools.sound.main.playSoundWindow("slender_me_ka_m.mp3;slender_me_ka.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[1]:
            pytools.sound.main.playSoundWindow("spahgnum_gr_cr_m.mp3;spahgnum_gr_cr.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[2]:
            pytools.sound.main.playSoundWindow("striped_gr_cr_m.mp3;striped_gr_cr.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[3]:
            pytools.sound.main.playSoundWindow("carolina_gr_cr_m.mp3;carolina_gr_cr.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[4]:
            pytools.sound.main.playSoundWindow("allards_gr_cr_m.mp3;allards_gr_cr.mp3", 50, speed, 0, 0)
        ...
        if (random.random() * 32768) < chance[7]:
            pytools.sound.main.playSoundWindow("curvetail_bu_ka_m.mp3;curvetail_bu_ka.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[8]:
            pytools.sound.main.playSoundWindow("forktail_bu_ka_m.mp3;forktail_bu_ka.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[0]:
            pytools.sound.main.playSoundWindow("marsh_me_gr_m.mp3;marsh_me_gr.mp3", 50, speed, 0, 0)
        if (random.random() * 32768) < chance[9]:
            pytools.sound.main.playSoundWindow("says_ci_m.mp3;says_ci.mp3", 50, speed, 0, 0)
