            ...
            if globals.run:
                try:
                    ...
                    if random.randrange(0, 35000) < bellsChance:
                        ...
                        pytools.sound.main.playSound('sleighbells_' + str(random.randrange(0, 5)) + ".mp3", ghSpeaker, 40, 1, 0, 0)
                    ...
                    if random.randrange(0, 35000) < outsideBandChance:
                        if int(globals.dayTimes[6][3]) > globals.dateArray[3]:
                            if int(globals.dayTimes[3][3]) < globals.dateArray[3]:
                                pytools.sound.main.playSound("outside_band.mp3", 0, 10, 1, 0, 0)
                                pytools.sound.main.playSound("outside_band.mp3", 1, 10, 1, 0, 0)
                                pytools.sound.main.playSoundWindow("outside_band.mp3;outside_band_nm.mp3", 10, 1, 0, 0)
            ...
            if globals.run and calc.isNiceDay():
                try:
                    ...
                    if random.randrange(0, 35000) < outsideBellsChance:
                        if int(globals.dayTimes[6][3]) > globals.dateArray[3]:
                            if int(globals.dayTimes[3][3]) < globals.dateArray[3]:
                                pytools.sound.main.playSound("outside_bells.mp3", 0, 10, 1, 0, 0)
                                pytools.sound.main.playSound("outside_bells.mp3", 1, 10, 1, 0, 0)
                                pytools.sound.main.playSoundWindow("outside_bells.mp3;outside_bells_nm.mp3", 10, 1, 0, 1)
                ...
                try:
                    ...
                    if random.randrange(0, 35000) < musicBoxChance:
                        ...
                        if random.randrange(0, 2) == 1:
                            pytools.sound.main.playSound("jinglebells_mb.mp3", ghSpeaker, 5, 1, 0, 1)
                        else:
                            pytools.sound.main.playSound("merrychristmas_mb.mp3", ghSpeaker, 5, 1, 0, 1)
                ...
                try:
                    if globals.dateArray[3] == 3:
                        if globals.dateArray[4] == 5:
                            if random.randrange(0, calc.getDayTic(globals.dateArray)) < 3:
                                if (sections.events.threeAmBells != globals.dateArray[2]) and (((globals.dateArray[1] == 11) and ((globals.dataArray[0][7] <= 0.5) or (globals.dataArray[0][3] != 0) or (globals.dataArray[0][4] == "snow"))) or (globals.dateArray[1] == 12)):
                                    sections.events.threeAmBells = globals.dateArray[2]
                                    pytools.sound.main.playSoundAll("3am_bells.mp3", 5, 1, 0, 0)
                    if globals.dateArray[3] == 18:
                        if globals.dateArray[4] == 10:
                            if (globals.dateArray[2] != sections.events.sixPmDinner):
                                ...
                                pytools.sound.main.playSoundAll("6pm_ch.mp3", 15, 1, 0, 0)
                    if globals.dateArray[3] == 21:
                        if globals.dateArray[4] == 23:
                            if random.randrange(0, calc.getDayTic(globals.dateArray)) < 5:
                                if (calc.getDayTic(globals.dateArray) > 2) and (((globals.dateArray[1] == 11) and ((globals.dataArray[0][7] <= 0.5) or (globals.dataArray[0][3] != 0) or (globals.dataArray[0][4] == "snow"))) or (globals.dateArray[1] == 12)):
                                    if sections.events.mmcBells != globals.dateArray[2]:
                                        ...
                                        pytools.sound.main.playSoundAll("mmcbells.mp3", 100, 1, 0, 0)
                except:
                    pass
            time.sleep(1)
            ...
            if globals.run and (((globals.dateArray[1] == 11) and ((globals.dataArray[0][7] <= 0.5) or (globals.dataArray[0][3] != 0) or (globals.dataArray[0][4] == "snow"))) or (globals.dateArray[1] == 12)):
                try:
                    ...
                    if random.randrange(0, 35000) < lateDayBellsChance:
                        pytools.sound.main.playSoundAll("lateday_bells.mp3", 10, 1, 0, 1)
            ...
            if globals.run and calc.isNiceDay() and (((globals.dateArray[1] == 11) and ((globals.dataArray[0][7] <= 0.5) or (globals.dataArray[0][3] != 0) or (globals.dataArray[0][4] == "snow"))) or (globals.dateArray[1] == 12)):
                try:
                    ...
                    if random.randrange(0, 35000) < lateNightChoirChance:
                        pytools.sound.main.playSoundAll("latenight_choir.mp3", 10, 1, 0, 1)
            ...
            if globals.run and (((globals.dateArray[1] == 11) and ((globals.dataArray[0][7] <= 0.5) or (globals.dataArray[0][3] != 0) or (globals.dataArray[0][4] == "snow"))) or (globals.dateArray[1] == 12)):
                try:
                    ...
                    if random.randrange(0, 35000) < mmcIdleChance:
                        pytools.sound.main.playSoundWindow("mmcidle.mp3;mmcidle.mp3", [20, 30], 1, 0, 1)
                    ...
                    try:
                        ...
                        if sections.events.santaLanding != globals.dateArray[2]:
                            if random.randrange(0, 35000) < sections.santa.landingChance:
                                pytools.sound.main.playSound("santalanding.mp3", 0, 10, 1, 0, 0)
                                pytools.sound.main.playSound("santalanding.mp3", 1, 10, 1, 0, 0)
                                pytools.sound.main.playSoundWindow("santalanding_wn.mp3;santalanding_nm.mp3", [10, 10], 1, 0, 0)
                    ...
                    try:
                        ...
                        if sections.events.santaLanding != globals.dateArray[2]:
                            if random.randrange(0, 35000) < sections.santa.sleighPassingChance:
                                pytools.sound.main.playSound("sleigh_passing.mp3", 0, 10, 1, 0, 0)
                                pytools.sound.main.playSound("sleigh_passing.mp3", 1, 10, 1, 0, 0)
                                pytools.sound.main.playSoundWindow("sleigh_passing_wn.mp3;sleigh_passing_nm.mp3", [10, 10], 1, 0, 1)
                            time.sleep(0.1)
                        else:
                            time.sleep(1)
                    except:
